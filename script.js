...
const CAT_ORDER = ['pure_dress', 'pure_homewear', 'pure_washedset', 'pure_polyesterset', 'pure_lotus', 'pure_waffle', 'pure_vest', 'mixed_dress', 'mixed_nodress', 'mixed_vest_4px', 'mixed', 'other', 'unknown'];
...
const CAT_CLASS = {
  ...
  mixed_vest_4px: 'cat-mixed', mixed: 'cat-mixed', other: 'cat-other',
};

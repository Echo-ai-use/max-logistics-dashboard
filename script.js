...
const CAT_ORDER = ['pure_dress', 'pure_homewear', 'pure_washedset', 'pure_polyesterset', 'pure_lotus', 'pure_waffle', 'mixed_dress', 'mixed_nodress', 'mixed', 'other', 'unknown'];
...
const CAT_CLASS = {
  ...
  pure_lotus: 'cat-wash', pure_polyesterset: 'cat-wash', pure_waffle: 'cat-waffle', mixed_dress: 'cat-mixed', mixed_nodress: 'cat-mixed',
  mixed: 'cat-mixed', other: 'cat-other',
};

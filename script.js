...
const CAT_ORDER = ['pure_dress', 'pure_homewear', 'pure_washedset', 'pure_polyesterset', 'pure_lotus', 'pure_waffle', 'pure_vest', 'mixed_dress', 'mixed_nodress', 'mixed_vest_4px', 'mixed', 'pure_gift', 'other', 'unknown'];
...
const CAT_CLASS = {
  ...
  pure_lotus: 'cat-wash', pure_polyesterset: 'cat-wash', pure_waffle: 'cat-waffle', pure_vest: 'cat-vest', mixed_dress: 'cat-mixed', mixed_nodress: 'cat-mixed',
  mixed_vest_4px: 'cat-mixed', mixed: 'cat-mixed', pure_gift: 'cat-gift', other: 'cat-other',
};
